...
and store the result in taxonomy.owl, run ELK as follows: 
    ...
    java -jar elk.jar -i ontology.owl -c -o taxonomy.owl
...
for classifying larger ontologies, e.g. by setting
    ...
    java -Xms256M -Xmx3G -jar elk.jar
    
or    

    java -XX:+AggressiveHeap -jar elk.jar	
...
The package elk.jar includes a number of third-party 
