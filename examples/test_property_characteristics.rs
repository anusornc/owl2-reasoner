use owl2_reasoner::axioms::{
    TransitivePropertyAxiom, SymmetricPropertyAxiom, ReflexivePropertyAxiom,
    FunctionalPropertyAxiom, InverseFunctionalPropertyAxiom,
    IrreflexivePropertyAxiom, AsymmetricPropertyAxiom, Axiom
};
