...
pub mod family {
    ...
    pub fn create_family_ontology() -> Ontology {
        ...
        let mut has_parent = ObjectProperty::new(IRI::new("http://example.org/family/hasParent").unwrap());
        ...
        let mut has_child = ObjectProperty::new(IRI::new("http://example.org/family/hasChild").unwrap());
        ...
        let mut has_spouse = ObjectProperty::new(IRI::new("http://example.org/family/hasSpouse").unwrap());
        ...
        let mut has_sibling = ObjectProperty::new(IRI::new("http://example.org/family/hasSibling").unwrap());
        ...
        ontology.add_equivalent_classes_axiom(EquivalentClassesAxiom::new(vec![
            mother.iri().clone(),
            IRI::new("http://example.org/family/FemaleParent").unwrap(),
        ])).unwrap();
        
        // Add property hierarchy
        ontology.add_axiom(Axiom::SubObjectProperty(SubObjectPropertyAxiom::new(
            has_child.iri().clone(),
...
pub mod biomedical {
    ...
    pub fn create_biomedical_ontology() -> Ontology {
        ...
        let genetic_disorder = Class::new(IRI::new("http://example.org/biomedical/GeneticDisorder").unwrap());
        ...
        // Define properties
        let has_symptom = ObjectProperty::new(IRI::new("http://example.org/biomedical/hasSymptom").unwrap());
        let has_treatment = ObjectProperty::new(IRI::new("http://example.org/biomedical/hasTreatment").unwrap());
        let encoded_by = ObjectProperty::new(IRI::new("http://example.org/biomedical/encodedBy").unwrap());
        let mut associated_with = ObjectProperty::new(IRI::new("http://example.org/biomedical/associatedWith").unwrap());
        ...
        ontology.add_object_property(associated_with.clone()).unwrap();
        ...
        let cystic_fibrosis = NamedIndividual::new(IRI::new("http://example.org/biomedical/CysticFibrosis").unwrap());
        let cftr_gene = NamedIndividual::new(IRI::new("http://example.org/biomedical/CFTR").unwrap());
        let cftr_protein = NamedIndividual::new(IRI::new("http://example.org/biomedical/CFTRProtein").unwrap());
        let insulin = NamedIndividual::new(IRI::new("http://example.org/biomedical/Insulin").unwrap());
        
        ontology.add_named_individual(cystic_fibrosis.clone()).unwrap();
    ...
    fn test_biomedical_reasoning() {
        ...
        let genetic_disorder_iri = IRI::new("http://example.org/biomedical/GeneticDisorder").unwrap();
        
        assert!(reasoner.is_subclass_of(&genetic_disorder_iri, &disease_iri).unwrap());
...
pub mod property_characteristics {
    ...
    pub fn create_property_test_ontology() -> Ontology {
        ...
        let mut has_friend = ObjectProperty::new(IRI::new("http://example.org/test/hasFriend").unwrap());
        ...
        let mut located_in = ObjectProperty::new(IRI::new("http://example.org/test/locatedIn").unwrap());
        located_in.add_characteristic(ObjectPropertyCharacteristic::Transitive);
            
        let mut has_parent = ObjectProperty::new(IRI::new("http://example.org/test/hasParent").unwrap());
        has_parent.add_characteristic(ObjectPropertyCharacteristic::Asymmetric);
        ...
        let manhattan = NamedIndividual::new(IRI::new("http://example.org/test/Manhattan").unwrap());
...
pub mod consistency {
    ...
    pub fn create_inconsistent_ontology() -> Ontology {
        ...
        // Make them disjoint
        ontology.add_disjoint_classes_axiom(DisjointClassesAxiom::new(vec![
            male.iri().clone(),
            female.iri().clone(),
        ])).unwrap();
        
        // Create individual that belongs to both (inconsistent)
        let contradictory_person = NamedIndividual::new(IRI::new("http://example.org/test/ContradictoryPerson").unwrap());
        ontology.add_named_individual(contradictory_person.clone()).unwrap();
...
pub mod performance {
    ...
    pub fn create_large_ontology(size: usize) -> Ontology {
        ...
        let participates_in = ObjectProperty::new(IRI::new("http://example.org/large/participatesIn").unwrap());
        ...
        ontology.add_object_property(participates_in.clone()).unwrap();
        
        // Create individuals
        for i in 0..size {
            let person_ind = NamedIndividual::new(IRI::new(&format!("http://example.org/large/Person{}", i)).unwrap());
        ...
        for i in 0..(size / 10) {
            let org_ind = NamedIndividual::new(IRI::new(&format!("http://example.org/large/Organization{}", i)).unwrap());
        ...
        for i in 0..(size / 5) {
            let project_ind = NamedIndividual::new(IRI::new(&format!("http://example.org/large/Project{}", i)).unwrap());
    ...
    fn test_large_ontology_performance() {
        ...
        println!("Consistency check for {} individuals took {:?}", size, duration);
        ...
        println!("Instance retrieval for {} people took {:?}", people.len(), duration);
